...
Assets::UniformBufferObject RayTracer::GetUniformBufferObject(const VkExtent2D extent) const
{
	...
	// std::cout << "ubo.TotalNumberOfSamples : " << ubo.TotalNumberOfSamples << std::endl;
	// std::cout << "ubo.NumberOfSamples : " << ubo.NumberOfSamples << std::endl;
	// std::cout << "ubo.NumberOfBounces : " << ubo.NumberOfBounces << std::endl;
...
{
	std::cout << "Raytracer::SetPhysicalDevice " << std::endl;
	// Required extensions.
...
{
	std::cout << "RayTracer::onDeviceSet" << std::endl;
	Application::OnDeviceSet();

	LoadScene(userSettings_.SceneIndex);
	std::cout << "LoadScene finish" << std::endl;
	CreateAccelerationStructures();
	std::cout << "CreateAccelerationStructures finish" << std::endl;
}

void RayTracer::CreateSwapChain()
{
	std::cout << "RayTracer::createSwapchain" << std::endl;
	Application::CreateSwapChain();
	std::cout << "RayTracer::userInterface" << std::endl;
