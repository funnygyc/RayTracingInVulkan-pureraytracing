	...
	textures_(std::move(textures))
{
	...
	std::cout << "CreateDeviceBuffer Vertices" << std::endl;
	...
	std::cout << "CreateDeviceBuffer Indices" << std::endl;
	...
	// Upload all textures
	std::cout << "Upload all textures : " << textures_.size() << std::endl;
	...
	{
		std::cout << "texture emplace_back " << std::endl;
	   textureImages_.emplace_back(new TextureImage(commandPool, textures_[i]));
	   std::cout << "texture image create finish : " << textureImages_[i]->ImageView().Handle() << std::endl;
