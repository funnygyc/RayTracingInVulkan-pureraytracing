	...
	presentMode_(presentMode)
{
	...
	std::cout << "arrive application::application" << std::endl;
	std::cout << "instance_ extensions number: " << instance_->Extensions().size() << std::endl;
...
{
	std::cout << "Application::SetPhysicalDevice " << std::endl;
	if (device_)
	{
	...
	void* nextDeviceFeatures)
{
	...
	std::cout << "create device finish " << std::endl;
	commandPool_.reset(new class CommandPool(*device_, device_->GraphicsFamilyIndex(), true));
	std::cout << "create commandpool finish " << std::endl;
}
...
void Application::CreateSwapChain()
{
	...
	std::cout << "Application::swapChain_->ImageViews" << std::endl;
	...
	// std::cout << "Application::createGraphicsPipeline" << std::endl;
	...
	// }
	std::cout << "Application::createCommandBuffers" << std::endl;
	commandBuffers_.reset(new CommandBuffers(*commandPool_, swapChain_->ImageViews().size()));
}
