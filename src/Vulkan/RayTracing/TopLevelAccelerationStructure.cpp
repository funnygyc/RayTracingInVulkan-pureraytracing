	...
	const VkDeviceSize resultOffset)
{
	...
	std::cout << "scratchOffset: " << scratchOffset << std::endl;
	std::cout << "ppBuildRangeInfos : " << pBuildOffsetInfo << std::endl;
    std::cout << "ppBuildRangeInfos[0]->primitiveCount : " << pBuildOffsetInfo->primitiveCount << std::endl;
    std::cout << "ppBuildRangeInfos[0]->primitiveOffset : " << pBuildOffsetInfo->primitiveOffset << std::endl;
    std::cout << "ppBuildRangeInfos[0]->firstVertex : " << pBuildOffsetInfo->firstVertex << std::endl;
    std::cout << "ppBuildRangeInfos[0]->transformOffset : " << pBuildOffsetInfo->transformOffset << std::endl;
